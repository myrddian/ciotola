...
package ciotola.network.parser;

import ciotola.Ciotola;
import ciotola.core.AnnotatorHandler;
import ciotola.network.ParserFactory;
import ciotola.network.annotations.TLVDataField;
import ciotola.network.annotations.TLVHeaderField;
import ciotola.network.annotations.TLVMessage;
import ciotola.network.parser.FieldDescriptor;
